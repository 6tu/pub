...
apt install -y openssl libssl-dev strongswan strongswan-pki
apt install -y libstrongswan libstrongswan-extra-plugins
...
# 替换配置文件
# : RSA   mfcgw1key.pem "<my passphrase>"
# : ECDSA client.key
...
/bin/cp -rf ~/.acme.sh/${domain}*/* /opt/vpn/
